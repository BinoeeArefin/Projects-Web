...
if(isset($_POST['add_comment'])){
   ...
   $admin_id = filter_var($admin_id, FILTER_UNSAFE_RAW);
   $user_name = $_POST['user_name'];
   $user_name = filter_var($user_name, FILTER_UNSAFE_RAW);
   $comment = $_POST['comment'];
   $comment = filter_var($comment, FILTER_UNSAFE_RAW);
...
if(isset($_POST['edit_comment'])){
   ...
   $edit_comment_id = filter_var($edit_comment_id, FILTER_UNSAFE_RAW);
   $comment_edit_box = $_POST['comment_edit_box'];
   $comment_edit_box = filter_var($comment_edit_box, FILTER_UNSAFE_RAW);
...
if(isset($_POST['delete_comment'])){
   ...
   $delete_comment_id = filter_var($delete_comment_id, FILTER_UNSAFE_RAW);
...
<?php
   ...
   $comment_id = filter_var($comment_id, FILTER_UNSAFE_RAW);
?>
